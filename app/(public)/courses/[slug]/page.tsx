  ...
  return (
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 mt-5">
      <div className="order-1 lg:col-span-2">
        <div className="relative aspect-video w-full overflow-hidden rounded-xl shado-lg">
          <Image
            src={`https://${env.NEXT_PUBLIC_S3_BUCKET_NAME_IMAGES}.fly.storage.tigris.dev/${course.fileKey}`} // Not that good but easier 乁( ͡° ͜ʖ ͡°)ㄏ
            alt="Thumbnail Image"
            fill
            priority
        ...
        <div className="mt-8 space-y-6">
          ...
          <div className="space-y-6">
            <h2 className="text-3xl font-semibol tracking-tight">
              Course Description
            </h2>
                    ...
                    <div className="border-t bg-muted/20">
                      <div className="p-6 pt-4 space-y-3">
                        {chapter.lessons.map((lesson, lessonIndex) => (
                          ...
                          >
                            <div className="flex size-8 items-center justify-center rounded-full bg-background border-2 border-primary/10">
